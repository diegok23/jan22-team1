    ...
    <ThemeProvider theme={theme}>
      ...
      <ContentSection  sx={{boxShadow:0}}>
          <Box >
            ...
            >
              Find <Typography variant='span' color='secondary' sx={{fontWeight:'800'}}>the best cycling routes</Typography> in your city, with good people.
            </Typography>
            <SearchPer>
            <SearchIconWrapper>
              <Search sx={{color:'secondary.main', fontSize:{xs:'1.5rem', md:'2rem'}}} />
            </SearchIconWrapper>
